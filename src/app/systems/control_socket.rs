...
/// representation.
fn building_piece_needle(piece: Option<&str>) -> Result<String> {
    Ok(match piece {
...
fn parse_building_piece(piece: &str) -> Result<crate::building::BuildingPiece> {
