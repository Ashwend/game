...
mod tests {
    ...
    fn no_auth_admits_the_claimed_identity() {
        let identity = authenticate(AuthMode::NoAuth, None, crate::protocol::AccountId(42), "")
            .expect("NoAuth trusts the claimed id");
        assert_eq!(identity.account_id, crate::protocol::AccountId(42));
